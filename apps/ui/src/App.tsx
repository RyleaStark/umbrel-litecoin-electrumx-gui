...
const unavailableStatus: IndexerStatus = {
  ...
  indexedHeight: null,
  percent: null,
  message: "ElectrumX status is temporarily unavailable",
};

function LoadingScreen() {
  return (
    <main className="app-shell loading-screen" aria-label="Loading ElectrumX">
      <div className="loading-content">
        <div className="loading-mark"><img src="/icon.png" alt="" /></div>
        <p>Connecting to ElectrumX</p>
  ...
  return (
    <main className="app-shell error-screen">
      <div className="error-card">
        ...
        <h1>ElectrumX is taking longer than expected</h1>
        <p>The interface could not load connection details. ElectrumX may still be starting.</p>
...
function FrameBlocked() {
  return (
    <main className="app-shell error-screen">
      <div className="error-card">
        <img src="/icon.png" alt="" className="error-icon" />
        <h1>Open ElectrumX in its own window</h1>
